...
However for the sake of streamlining this course I will point you to a few key resources if you are starting from ground zero or the root of the tree :)

### In terms of Books:

-   [Phylogenetic Comparative Methods in R](https://press.princeton.edu/books/ebook/9780691219042/phylogenetic-comparative-methods-in-r) by Liam Revell and Luke Harmon. [An amazing book that is where I started learning how to understand and analyze phylogenetic trees. This book has amazing examples some of which have helped me design this course. This is very code focused and should be coupled with a 'theory' based book like below.]
...
-   [The Phytools R Package](https://peerj.com/articles/16505/) by Liam Revell. [An amazing R package that is constantly "evolving" and gaining new functions all the time. This package also makes plotting phylogenies wonderful]{.underline}
...
More detaisl about the course can be found in the Course Syllabus tab. 
